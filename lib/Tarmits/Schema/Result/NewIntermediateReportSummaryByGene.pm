use utf8;
package Tarmits::Schema::Result::NewIntermediateReportSummaryByGene;
...
Tarmits::Schema::Result::NewIntermediateReportSummaryByGene
...
=head1 TABLE: C<new_intermediate_report_summary_by_gene>

=cut

__PACKAGE__->table("new_intermediate_report_summary_by_gene");
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'new_intermediate_report_summary_by_gene_id_seq'
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+eWGyuCcYAKD2wni1THaFg
