use utf8;
package Tarmits::Schema::Result::NewIntermediateReportSummaryByCentreAndConsortia;
...
Tarmits::Schema::Result::NewIntermediateReportSummaryByCentreAndConsortia
...
=head1 TABLE: C<new_intermediate_report_summary_by_centre_and_consortia>

=cut

__PACKAGE__->table("new_intermediate_report_summary_by_centre_and_consortia");
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'new_intermediate_report_summary_by_centre_and_consortia_id_seq'
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mNOpKI6paJA8NQUVg37uSw
