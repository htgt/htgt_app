use utf8;
package Tarmits::Schema::Result::NewIntermediateReportSummaryByMiPlan;
...
Tarmits::Schema::Result::NewIntermediateReportSummaryByMiPlan
...
=head1 TABLE: C<new_intermediate_report_summary_by_mi_plan>

=cut

__PACKAGE__->table("new_intermediate_report_summary_by_mi_plan");
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'new_intermediate_report_summary_by_mi_plan_id_seq'
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:O0oLz+pkPAk2IdlY89NQZg
